...
text_speed_dir='./text_files/text_speed.txt'
image_dir='D:/sproj 2/Code/Dataset/Ringroad/frames_all_resized_new/content/resized_all_skipped_5/0.jpg'
f=open(text_speed_dir,'w')
...
flow = None
result = None
normalize_meters = 12.192 # This is the 10 meters
temp_approx_meters_p1 = 12.192 # Basically, allow the user to put any scale rather than forcing them to put something of 10m. Hardcoded to 2 rn.
temp_approx_meters_p2 = 12.192 # Same as above but for the other end
