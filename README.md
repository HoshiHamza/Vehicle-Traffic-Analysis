...
You only need to run the first section if you have the data in shape of a video. If data is in format of frames you need to start from subsection 2. For the vehicle detection section, you need to copy model i.e. .weights file which was created during training. You only need to change path to directories in top cell of this section and run the rest of the cells as it is in the Vehicle Detection section.
...
### Requirements
- Text file containing bounding box locations generated, by Yolo Vehicle Detection
- Text file containing pixel cordinates of counter lines 
- Frames
...
### Requirements
- Text file containing center pixel cordinates 
